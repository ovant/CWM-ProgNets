...
parser MyParser(packet_in packet,
    ...
    state parse_p4scramb {
        packet.extract(hdr.p4scramb);
        transition accept;
    }
}
...
control MyIngress(inout headers hdr,
    ...
    action simple_xor(bit<32> my_key) {
        bit<32> my_msg;
        my_msg = hdr.p4scramb.secret ^ my_key;
        send_back(my_msg);
    }
